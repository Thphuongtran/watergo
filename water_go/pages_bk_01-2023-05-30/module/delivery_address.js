const PageDeliveryAddress = {
   ...
   template: `
   <div v-if='$root.navigator == "delivery_address"' class='page-delivery-address'>
   ...
   <div v-if='$root.navigator == "delivery_address_add"' class='page-delivery-address'>
      <div class='appbar'>
         <div class='leading'>
            <button @click='$root.goBack' class='btn-action'>
               <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
   ...
   <div v-if='$root.navigator == "delivery_address_edit"' class='page-delivery-address'>
      <div class='appbar'>
         <div class='leading'>
            <button @click='$root.goBack' class='btn-action'>
               <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
   ...
   methods: {
      // gotoPage( page ){ this.navigator = page; },
      ...
      gotoAdd(){
         this.$root.gotoPage("delivery_address_add", { back: "delivery_address"} );
         this.resetForm();
      },
      ...
      async editDeliveryAddress( id_delivery ){
         this.$root.gotoPage('delivery_address_edit', {back: "delivery_address"});
      ...
      async deleteDeliveryAddress(){
         ...
         if(r != undefined ){
            ...
            if( res.message == 'delete_delivery_address_ok' ){
               ...
               this.$root.goBack();
               // this.$root.gotoPage('delivery_address');
            }
         }
      }
         ...
         if( r != undefined ){
            ...
            if( res.message == 'get_delivery_address_ok' ){
               if( res.data != undefined ){
                  ...
                  this.$root.delivery_address.push( ...res.data );
               }
            }
         }
      }
