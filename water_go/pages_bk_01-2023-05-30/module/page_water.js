const PageWater = {
   name: 'PageWater',
   template: `
      <div v-if='$root.navigator == "water"' class='page-home-water'>
         <div class='appbar'>
            <div class='leading'>
         ...
         <div class='inner'>
            <div class='grid-masonry'>
               <div @click='$root.gotoPage("product-detail",{ product_id: product.id, back: "water" })' class='product-design' v-for='(product, index) in productWater ' :key='index'>
                  <div class='img'>
   ...
   data(){
      return{ 
         ...
         categoryWater: [
            { id: 1, name: 'Bình vòi', active: false, },
            { id: 2, name: 'Bình úp', active: false, },
            { id: 3, name: 'Bình 5L', active: false, },
            { id: 4, name: 'Nước chai', active: false },
         ],
         brandsWater: [
            { id: 1, name: 'Aquafina'},
            { id: 2, name: 'Viva' },
   ...
   async created(){
      ...
      if( r != undefined ){
         ...
         if( res.message == 'product_found' ){
            this.productWater.push( ...res.data);
         }
      }
