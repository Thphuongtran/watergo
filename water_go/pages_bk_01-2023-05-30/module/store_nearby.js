const StoreNearby = {
   ...
   template: `
      <div class='gr-heading mt40'>
         <p class='heading'>Nearby</p><span class='link'>See All</span>
      </div>

      <div class='list-horizontal'>
         <ul>
            <li v-if='stores.length > 0' v-for='(item, index) in stores' :key='index' class='product-design store-style'>
               <div class='img'>
                  <img :src='get_image_store(item.id)'>
               </div>
               <p class='tt01'>{{ item.name }} </p>
               <p class='tt02'>
