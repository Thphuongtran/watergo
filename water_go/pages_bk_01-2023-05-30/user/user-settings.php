            ...
            <div class='box-justify-between'>
               ...
               <div class='form-wrapper'>
                  ...
                  <div class='form-group style01'>
                     ...
                     <input v-model='settings_new_password' type="password" placeholder='Enter new password'>
                  </div>
                  <div class='form-group style01'>
                     <span>Confirm New Password</span>
                     <input v-model='settings_confirm_password' type="password" placeholder='Enter new password'>
                  </div>
               </div>
