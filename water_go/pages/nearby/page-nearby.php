...
createApp({
   ...
   methods: {
      ...
      truncateUTF8String(str, maxLength) {
         if (str.length <= maxLength) {
            ...
            // Remove any incomplete multi-byte character at the end of the truncated string
   ...
   async mounted(){
      ...
      // marker.addEventListener("drag", function (event) {
      //    const newPosition = map.screenToGeo(event.currentPointer.viewportX, event.currentPointer.viewportY);
      //    console.log('drag event');
      //    console.log(newPosition);
      //    // calculateDistance(prevLocation, newPosition);
      // });
