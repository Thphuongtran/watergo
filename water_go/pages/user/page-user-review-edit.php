   ...
   <div v-show='loading == false' class='page-review-form'>
      ...
      <div class='inner'>
         ...
         <label class='input-review'>
            ...
            <textarea v-model='review_text' placeholder='<?php echo __('Write your review', 'watergo'); ?>....'></textarea>
         </label>
      </div>

      <div class='btn-fixed bottom'>
         <button @click='submit' class='btn btn-primary'><?php echo __('Save', 'watergo'); ?></button>
      </div>
