      ...
      <div class='appbar'>
         <div class='appbar-top'>
            <div class='leading'>
               ...
               <p class='leading-title'>Delete Account</p>
            </div>
         </div>
      </div>
         ...
         <div class='page-delete-account'>
            <div class='box-justify-between'>
               <div v-if='settings_delete_account_step == 0' class='contents-wrapper'>
                  ...
                  <ul class='list-delete-account'>
                     ...
                     <li @click='buttonUserSettingsQuestionSelected(index)' v-for='(question, index) in settings_delete_account_question' :key='index'>
                        <div class='radio-button small' :class='settings_delete_account_question_selected == index ? "active" : ""'></div>
               ...
               <div class='btn-fixed bottom style01'>
                  <button @click='buttonUserCancelDeleteAccount' class='btn btn-outline'>Cancel</button>
                  <button @click='buttonUserDeleteAccount' class='btn btn-primary'>Continue</button>
               </div>
            </div>
         </div>
