      ...
      <div class='appbar style01'>
         <div class='appbar-top'>
            ...
            <div class='action'>
               ...
               <div v-show='is_water_device_selected == false' class='filter-type-water'>
                  <span class='icon'>
                  ...
                  <div class='filter_type_water_box'>
                     <div @click='open_filter_type_water' class='filter_type_water_placeholder'>
                        <?php echo __('Type of water', 'watergo'); ?>
                     </div>
                     <div  
                        class='filter_type_water_modal' 
                        :class='filter_type_water_open == true ? "active" : ""'>
                        <div 
                           @click='select_category_parent(type_water.name)'
                           v-for='(type_water, type_water_index) in category_parent' :key='type_water_index'
                           class='item' :class='type_water.active ? "active" : ""'
                        >
                           {{ type_water.name }}
                        </div>
                     </div>
         ...
         <div class='appbar-bottom'>
            <div v-if='sortFeatureOpen == true' class='box-sort' :class='sortFeatureOpen == true ? "active" : ""'>
               <ul>
                  <li @click='buttonSortFeatureSelected(0)' :class='sortFeatureCurrentValue == 0 ? "active" : ""'>
                     <?php echo __('Nearest', 'watergo'); ?></li>
                  <li @click='buttonSortFeatureSelected(1)' :class='sortFeatureCurrentValue == 1 ? "active" : ""'>
                     <?php echo __('Cheapest', 'watergo'); ?></li>
                  <li @click='buttonSortFeatureSelected(2)' :class='sortFeatureCurrentValue == 2 ? "active" : ""'>
...
createApp({
   ...
   methods: {
      ...
      open_filter_type_water(){
         this.filter_type_water_open = !this.filter_type_water_open;
      },
      ...
      handleClickOutside(e){
         ...
         if( _exists == false ){
            this.filter_type_water_open = false;
            this.sortFeatureOpen = false;
         }
      },
