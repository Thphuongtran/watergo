...
var iframe = Vue.createApp({
   ...
   methods: {
      ...
      async btn_modal_confirm(){
         ...
         form.append('action', 'atlantis_product_hidden');
            ...
            $('#discount_from').datepicker({
               ...
               onSelect: function(dateText, inst){
                  if(dateText != undefined || dateText != '' || dateText != null){
                     ...
                     window.iframe.product.discount_from = dateText;
            ...
            $('#discount_to').datepicker({
               ...
               onSelect: function(dateText, inst){
                  if(dateText != undefined || dateText != '' || dateText != null){
                     ...
                     window.iframe.product.discount_to = dateText;
                  }
               },
               onClose: function(dateText, inst){
                  $('.ui-date-picker-wrapper').removeClass('active');
