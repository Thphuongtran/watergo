...
<div v-if="loading == true">
   ...
   data(){
      return {
         ...
         out_of_stock: false, // cant order
         store_stop_working: false, // cant order
      }
   },
   methods: {
      ...
      async findProduct( product_id ){
         ...
         if( r != undefined ){
            ...
            if( res.message == 'product_found' ){
               ...
               // out of stock
               if( this.product_detail.mark_out_of_stock == 1 ) {
      ...
      async findStore( store_id ){
         ...
         if( r != undefined ){
            ...
            if(res.message == 'store_found' ){
               ...
               if( this.check_store_time_working(this.store.start_time, this.store.close_time ) == true ){
      ...
      plusQuantity( stock ){
         if( this.check_can_order == true && this.product_quantity_count < stock ){ this.product_quantity_count++; }
      },
   ...
   computed: {
      check_can_order(){
         if( this.product_quantity_count > 0 && this.canOrder == true ){
            return true;
         }else{
            return false;
         }
