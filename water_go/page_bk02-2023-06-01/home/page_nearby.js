const PageNearby = {
   name: 'PageNearby',
   template: `
<div v-if='$root.navigator == "nearby"' class='page-nearby'>
   ...
   <div v-if='stores.length > 0 && loading == false' class='inner'>
      <div class='grid-masonry'>
         <div @click='$root.gotoPage("store-detail",{ store_id: store.id, back: "nearby" })' 
