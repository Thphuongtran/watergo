         ...
         <div v-if='store != null' class='list-tile shop-card'>
            ...
            <div class='content'>
               <div class='heading'>
                  ...
                  <div class='actions'>
                     <button @click='$root.gotoPage("store-detail", { back: "product-detail", product_id: this.product_detail.id, store_id: this.store.id })' class='btn-text'>View Store</button>
                  </div>
               </div>
               <div class='meta'> 
...
<div v-if="loading == true">
   ...
   methods: {
      ...
      gotoPageOrder(){
         if( this.check_can_order == true ){
            ...
            this.$root.carts.some(store => {
               store.products.every( product => product.product_select = true);
            });
            this.$root.gotoPage('order', { back: 'product-detail', product_id: this.product_detail.id });
         }
      },
      ...
      renew(){
         ...
         this.canOrder = false;
         this.modal_store_working
         this.modal_store_out_of_stock
      },
